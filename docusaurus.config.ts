...
const config: Config = {
  title: 'DAHVI',
  tagline: 'Distributed Audio Haptic Visual Interface',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Team Audiaptic & Rochester Institute of Technology. All Rights Reserved. Built with Docusaurus.`,
    },
    prism: {
